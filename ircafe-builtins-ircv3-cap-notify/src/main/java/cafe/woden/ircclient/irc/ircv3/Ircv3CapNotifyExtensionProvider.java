...
/** Built-in metadata provider for the IRCv3 cap-notify capability. */
@AutoService(Ircv3ExtensionProvider.class)
public final class Ircv3CapNotifyExtensionProvider implements Ircv3ExtensionProvider {

  private static final String CAPABILITY = "cap-notify";
