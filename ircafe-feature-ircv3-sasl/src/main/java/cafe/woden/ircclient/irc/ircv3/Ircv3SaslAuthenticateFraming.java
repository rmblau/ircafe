...
public final class Ircv3SaslAuthenticateFraming {

  private static final int SASL_CHUNK_LEN = 400;

  private final StringBuilder inboundBase64 = new StringBuilder();

  public Optional<byte[]> acceptServerPayload(String data) throws Ircv3SaslException {
  ...
  public List<String> encodeClientResponse(String base64Payload) {
  ...
  private byte[] finishServerMessage() throws Ircv3SaslException {
    ...
    try {
      ...
      throw new Ircv3SaslException(
          Ircv3SaslException.Reason.OTHER, "Invalid base64 from server during SASL", e);
    }
  }
}
