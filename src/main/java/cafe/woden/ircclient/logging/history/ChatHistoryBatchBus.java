...
public final class ChatHistoryBatchBus
    extends AbstractTargetWaiterBus<ChatHistoryBatchBus.BatchEvent> {
  ...
  public ChatHistoryBatchBus(
      @Qualifier(ExecutorConfig.CHATHISTORY_BATCH_BUS_SCHEDULER)
          ScheduledExecutorService scheduler) {
    super(scheduler, "CHATHISTORY batch", "CHATHISTORY batch bus completion failed", log);
  }
