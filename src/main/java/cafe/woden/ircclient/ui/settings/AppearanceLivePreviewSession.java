...
final class AppearanceLivePreviewSession implements AutoCloseable {
  ...
  void restoreCommittedAppearance() {
  ...
  private void updateFlatTweakCapabilityUi() {
    ...
    tweaks.density.setToolTipText(
        flatTweakCapable ? PreferencesDialog.DENSITY_TOOLTIP : FLAT_ONLY_TOOLTIP);
    tweaks.cornerRadius.setToolTipText(
        flatTweakCapable ? PreferencesDialog.CORNER_RADIUS_TOOLTIP : FLAT_ONLY_TOOLTIP);
  }
