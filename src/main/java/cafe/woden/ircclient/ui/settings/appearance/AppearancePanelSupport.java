...
final class AppearancePanelSupport {
  ...
  static JPanel buildPanel(
    ...
    form.add(PreferencesUiSupport.tabTitle("Appearance"), "growx, wmin 0, wrap");
  ...
  private static JPanel buildThemeSubTab(
    ...
    panel.add(PreferencesUiSupport.sectionTitle("Look & feel"), "span 2, growx, wmin 0, wrap");
  ...
  private static JPanel buildUiFontSubTab(TweakControls tweaks) {
    ...
    panel.add(PreferencesUiSupport.sectionTitle("UI text"), "span 2, growx, wmin 0, wrap");
  ...
  private static JPanel buildChatColorsSubTab(ChatThemeControls chatTheme) {
    ...
    panel.add(PreferencesUiSupport.sectionTitle("Palette"), "growx, wmin 0, wrap");
    panel.add(buildChatThemePaletteSubTab(chatTheme), "growx, wmin 0, wrap");

    panel.add(PreferencesUiSupport.sectionTitle("Message colors"), "growx, wmin 0, wrap");
  ...
  private static JPanel buildChatTextSubTab(FontControls fonts) {
    ...
    panel.add(PreferencesUiSupport.sectionTitle("Chat text"), "span 2, growx, wmin 0, wrap");
    panel.add(new JLabel("Font family"));
  ...
  private static JPanel buildServerTreeSubTab(AppearanceServerTreeControls serverTree) {
    ...
    panel.add(PreferencesUiSupport.sectionTitle("Server tree"), "span 2, growx, wmin 0, wrap");
