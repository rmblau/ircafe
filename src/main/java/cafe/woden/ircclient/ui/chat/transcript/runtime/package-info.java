 ...
 * restyle scheduling, auxiliary-row lifecycle cleanup, runtime flow coordination, transcript rebuild
 * orchestration, target close/clear operations, and per-target state coordination.
 */
