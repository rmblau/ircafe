...
/** Coordinates destructive transcript rebuilds from recent persisted history. */
public final class ChatTranscriptRebuildCoordinator {

  private final UiPort ui;
  private final ChatHistoryService history;
  private final Logger log;

  public ChatTranscriptRebuildCoordinator(UiPort ui, ChatHistoryService history, Logger log) {
