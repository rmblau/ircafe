 ...
 */
public final class ChatTranscriptAttrSupport {
   ...
   */
  public static boolean isConversationLine(AttributeSet attrs) {
   ...
   */
  public static Long lineEpochMs(AttributeSet attrs) {
   ...
   */
  public static LogKind logKindFromAttrs(AttributeSet attrs) {
   ...
   */
  public static LogDirection logDirectionFromAttrs(AttributeSet attrs) {
   ...
   */
  public static FilterAction filterActionFromAttr(Object raw) {
