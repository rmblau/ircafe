 ...
 * spoiler-support, message, message-support, and runtime context-binding helpers, behind the
 * public transcript entry points without exposing the individual implementation collaborators as a
