...
public final class ChatReadMarkerCoordinator {
  ...
  public int savedScrollValue() {
    return state().scrollValue;
  }

  public void setSavedScrollValue(int value) {
    state().scrollValue = value;
  }

  public void applyReadMarkerViewState(TargetRef target, int unreadJumpOffset) {
