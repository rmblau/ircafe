...
class HexChatCommandAliasImportServiceTest {

  private final HexChatCommandAliasImportService service = new HexChatCommandAliasImportService();

  @Test
  void parsesCommandsConfAndMergesDuplicateCommandNames() {
    HexChatCommandAliasImportResult out =
        service.parseLines(
            List.of(
                "# comment",
                "NAME SLAP",
