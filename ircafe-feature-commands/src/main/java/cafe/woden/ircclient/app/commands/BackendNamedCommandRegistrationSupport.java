...
/** Feature-owned command-name policy shared by backend-named parser and executor registries. */
public final class BackendNamedCommandRegistrationSupport {
  ...
  public static boolean isReservedCommandName(String commandName) {
    return RESERVED_COMMAND_NAMES.contains(normalizeCommandName(commandName));
  }
}
