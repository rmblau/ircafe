...
class Ircv3WhoisParserTest {
  ...
  void parsesWhoisAndWhowasUsersWithOptionalTagsAndPrefix() {
    ...
    assertEquals(
        ...
        Ircv3WhoisParser.parseRpl314WhowasUser(":server 314 me bob user old.example * :Bob"));
  }
  ...
  void parsesAwayAccountAndEndOfWhois() {
    assertEquals(
        ...
        Ircv3WhoisParser.parseRpl301WhoisAway(":server 301 me alice :Gone fishing"));
    assertEquals(
    ...
    assertEquals(
        "alice",
        Ircv3WhoisParser.parseRpl318EndOfWhoisNick(":server 318 me alice :End of /WHOIS list"));
  }
