...
public final class Ircv3Tags {
  ...
  public static Map<String, String> fromEvent(Object pircbotxEvent) {
    ...
    if (tags instanceof Map<?, ?> map && !map.isEmpty()) {
      Map<String, String> parsed = fromMap(map);
  ...
  /** Normalizes a transport-supplied message-tag map without decoding values again. */
  public static Map<String, String> fromMap(Map<?, ?> rawTags) {
    return normalizeTagMap(rawTags, false);
  }

  public static Map<String, String> fromRawLine(String rawLine) {
  ...
  public static String firstTagValue(Map<String, String> tags, String... keys) {
  ...
  /** Returns the first matching non-blank tag value after IRCv3 escape decoding. */
  public static String firstDecodedTagValue(Map<String, String> tags, String... keys) {
    return unescapeTagValue(firstTagValue(tags, keys));
  }
