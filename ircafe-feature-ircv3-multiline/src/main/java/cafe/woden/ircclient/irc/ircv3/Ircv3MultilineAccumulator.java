...
public final class Ircv3MultilineAccumulator {
  ...
  public FoldResult fold(
    ...
    String batchId = firstTagValue(safeTags, BATCH_TAG);
  ...
  private static String firstTagValue(Map<String, String> tags, String rawKey) {
    if (tags == null || tags.isEmpty()) return "";
    String wanted = Ircv3MultilineSupport.normalizeTagKey(rawKey);
    if (wanted.isEmpty()) return "";
    for (Map.Entry<String, String> entry : tags.entrySet()) {
      if (!wanted.equals(Ircv3MultilineSupport.normalizeTagKey(entry.getKey()))) continue;
