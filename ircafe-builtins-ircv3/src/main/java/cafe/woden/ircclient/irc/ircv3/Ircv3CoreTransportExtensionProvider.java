  ...
  public List<Ircv3ExtensionContribution> extensions() {
    return List.of(
        Ircv3ExtensionProviderSupport.capability(
            Ircv3CapabilityNames.MULTI_PREFIX,
        ...
        Ircv3ExtensionProviderSupport.capability(
            Ircv3CapabilityNames.CAP_NOTIFY,
            Ircv3SpecStatus.STABLE,
            "CAP updates",
            Ircv3UiGroup.CORE,
            140,
        ...
        Ircv3ExtensionProviderSupport.capability(
            Ircv3CapabilityNames.INVITE_NOTIFY,
            Ircv3SpecStatus.STABLE,
        ...
        Ircv3ExtensionProviderSupport.capability(
            Ircv3CapabilityNames.AWAY_NOTIFY,
            Ircv3SpecStatus.STABLE,
            "Away status updates",
            Ircv3UiGroup.CORE,
            90,
        ...
        Ircv3ExtensionProviderSupport.capability(
            Ircv3CapabilityNames.ACCOUNT_NOTIFY,
            Ircv3SpecStatus.STABLE,
        ...
        Ircv3ExtensionProviderSupport.capability(
            Ircv3CapabilityNames.EXTENDED_JOIN,
            Ircv3SpecStatus.STABLE,
            "Extended join data",
            Ircv3UiGroup.CORE,
            100,
        ...
        Ircv3ExtensionProviderSupport.capability(
            Ircv3CapabilityNames.MESSAGE_TAGS,
            Ircv3SpecStatus.STABLE,
            "Message tags",
            Ircv3UiGroup.CORE,
            10,
        ...
        Ircv3ExtensionProviderSupport.capability(
            Ircv3CapabilityNames.SERVER_TIME,
            Ircv3SpecStatus.STABLE,
            "Server timestamps",
            Ircv3UiGroup.CORE,
            30,
        ...
        Ircv3ExtensionProviderSupport.capability(
            Ircv3CapabilityNames.STANDARD_REPLIES,
            Ircv3SpecStatus.STABLE,
            "Standard replies",
            Ircv3UiGroup.CORE,
            60,
        ...
        Ircv3ExtensionProviderSupport.capability(
            Ircv3CapabilityNames.ECHO_MESSAGE,
            Ircv3SpecStatus.STABLE,
            "Echo own messages",
            Ircv3UiGroup.CORE,
            40,
        ...
        Ircv3ExtensionProviderSupport.capability(
            Ircv3CapabilityNames.LABELED_RESPONSE,
            Ircv3SpecStatus.STABLE,
            "Labeled responses",
            Ircv3UiGroup.CORE,
            50,
